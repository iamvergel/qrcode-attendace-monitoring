...
if (isset($_POST['insertdata'])) {
    ...
    $sql = "INSERT INTO tblappointment (patient_id,patient_name,doc_id,schedule,sched_id,starttime,endtime,reason,schedtype,status,payment_option,personal_status,occupation,complain,created_at)
        VALUES ('$patient_id','$patient_name','$doctor_id','$schedDate','$sched_id','$schedStart','$schedEnd','$preferredServices','$schedtype','$status','Cash','$personal_status','$occupation','$complain','$date_submitted')";
    $query_run = mysqli_query($conn, $sql);
    ...
    if ($query_run) {
        ...
        echo json_encode([
            'status' => 'success',
            'message' => 'Appointment successfully submitted. Payment will be processed when you arrive for your appointment.'
