                            ...
                            <div class="w-100 d-flex">
                              ...
                              <table id="appointment" class="table table-bordered table-hover" id="indi-list">
                                ...
                                <tbody>
                                  <?php
                                    $i = 1;
                                    $sql = "SELECT a.*, CONCAT(p.fname,' ',p.lname) AS pname FROM tblappointment a,tbluser p WHERE p.id = a.patient_id";
                                    $query_run = mysqli_query($conn, $sql);
                      ...
                      <div class="container-fluid">
                              <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  <?php
                                    $i = 1;
                                    $sql = "SELECT a.*, CONCAT(p.fname,' ',p.lname) AS pname FROM tblappointment a,tbluser p WHERE p.id = a.patient_id AND status = 'Pending' ";
                                    $query_run = mysqli_query($conn, $sql);
